...
struct ipoque_detection_module_struct *ipoque_init_detection_module(
    u32 ticks_per_second, void *(*ipoque_malloc)(unsigned long size),
    ...
    if (ipq_str == NULL) {
        ipoque_debug_printf(
            0, NULL, IPQ_LOG_DEBUG,
            "ipoque_init_detection_module initial malloc failed\n");
        return NULL;
    }
    ...
    ipq_str->tcp_max_retransmission_window_size =
    ...
    ipq_str->gadugadu_peer_connection_timeout =
        IPOQUE_GADGADU_PEER_CONNECTION_TIMEOUT * ticks_per_second;
    ipq_str->edonkey_upper_ports_only = IPOQUE_EDONKEY_UPPER_PORTS_ONLY;
    ipq_str->ftp_connection_timeout =
        IPOQUE_FTP_CONNECTION_TIMEOUT * ticks_per_second;

    ipq_str->pplive_connection_timeout =
        IPOQUE_PPLIVE_CONNECTION_TIMEOUT * ticks_per_second;

    ipq_str->rtsp_connection_timeout =
        IPOQUE_RTSP_CONNECTION_TIMEOUT * ticks_per_second;
    ipq_str->tvants_connection_timeout =
        IPOQUE_TVANTS_CONNECTION_TIMEOUT * ticks_per_second;
    ipq_str->irc_timeout = IPOQUE_IRC_CONNECTION_TIMEOUT * ticks_per_second;
    ipq_str->gnutella_timeout =
        IPOQUE_GNUTELLA_CONNECTION_TIMEOUT * ticks_per_second;

    ipq_str->battlefield_timeout =
        IPOQUE_BATTLEFIELD_CONNECTION_TIMEOUT * ticks_per_second;

    ipq_str->thunder_timeout =
        IPOQUE_THUNDER_CONNECTION_TIMEOUT * ticks_per_second;
    ipq_str->yahoo_detect_http_connections =
        IPOQUE_YAHOO_DETECT_HTTP_CONNECTIONS;

    ipq_str->yahoo_lan_video_timeout =
        IPOQUE_YAHOO_LAN_VIDEO_TIMEOUT * ticks_per_second;
    ipq_str->zattoo_connection_timeout =
        IPOQUE_ZATTOO_CONNECTION_TIMEOUT * ticks_per_second;
    ipq_str->jabber_stun_timeout =
        IPOQUE_JABBER_STUN_TIMEOUT * ticks_per_second;
    ipq_str->jabber_file_transfer_timeout =
        IPOQUE_JABBER_FT_TIMEOUT * ticks_per_second;
    ipq_str->soulseek_connection_ip_tick_timeout =
        IPOQUE_SOULSEEK_CONNECTION_IP_TICK_TIMEOUT * ticks_per_second;
    ipq_str->manolito_subscriber_timeout = IPOQUE_MANOLITO_SUBSCRIBER_TIMEOUT;
    return ipq_str;
}

void ipoque_exit_detection_module(
...
void ipoque_set_protocol_detection_bitmask2(
    struct ipoque_detection_module_struct *ipoque_struct,
    const IPOQUE_PROTOCOL_BITMASK *dbm) {
    ...
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_MPEG) != 0)
        goto hack_do_http_detection;
#endif
#ifdef IPOQUE_PROTOCOL_FLASH
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_FLASH) != 0)
        goto hack_do_http_detection;
#endif
#ifdef IPOQUE_PROTOCOL_QUICKTIME
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_QUICKTIME) != 0)
        goto hack_do_http_detection;
#endif
#ifdef IPOQUE_PROTOCOL_REALMEDIA
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_REALMEDIA) != 0)
        goto hack_do_http_detection;
#endif
#ifdef IPOQUE_PROTOCOL_WINDOWSMEDIA
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_WINDOWSMEDIA) != 0)
        goto hack_do_http_detection;
#endif
#ifdef IPOQUE_PROTOCOL_MMS
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_MMS) != 0)
        goto hack_do_http_detection;
#endif
#ifdef IPOQUE_PROTOCOL_OFF
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_OFF) != 0)
        goto hack_do_http_detection;
#endif
#ifdef IPOQUE_PROTOCOL_XBOX
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_XBOX) != 0)
        goto hack_do_http_detection;
#endif
#ifdef IPOQUE_PROTOCOL_QQ
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_QQ) != 0)
        goto hack_do_http_detection;
#endif
#ifdef IPOQUE_PROTOCOL_AVI
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_AVI) != 0)
        goto hack_do_http_detection;
#endif
#ifdef IPOQUE_PROTOCOL_OGG
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_OGG) != 0)
        goto hack_do_http_detection;
#endif
#ifdef IPOQUE_PROTOCOL_MOVE
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_MOVE) != 0)
        goto hack_do_http_detection;
#endif
#ifdef IPOQUE_PROTOCOL_RTSP
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_RTSP) != 0)
        goto hack_do_http_detection;
#endif
    /* HTTP DETECTION MUST BE BEFORE DDL BUT AFTER ALL OTHER PROTOCOLS WHICH USE
     * HTTP ALSO */
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_HTTP) != 0) {
    hack_do_http_detection:
        ...
        ipoque_struct->callback_buffer[a].ipq_selection_bitmask =
            IPQ_SELECTION_BITMASK_PROTOCOL_V4_V6_TCP_WITH_PAYLOAD;
        ...
        IPOQUE_ADD_PROTOCOL_TO_BITMASK(
            ipoque_struct->callback_buffer[a].detection_bitmask,
            IPOQUE_PROTOCOL_QUICKTIME);
#endif
#ifdef IPOQUE_PROTOCOL_REALMEDIA
        IPOQUE_ADD_PROTOCOL_TO_BITMASK(
            ipoque_struct->callback_buffer[a].detection_bitmask,
            IPOQUE_PROTOCOL_REALMEDIA);
#endif
#ifdef IPOQUE_PROTOCOL_WINDOWSMEDIA
        IPOQUE_ADD_PROTOCOL_TO_BITMASK(
            ipoque_struct->callback_buffer[a].detection_bitmask,
        ...
        IPOQUE_BITMASK_SET(
            ipoque_struct->callback_buffer[a].excluded_protocol_bitmask,
            ipoque_struct->callback_buffer[a].detection_bitmask);
        IPOQUE_DEL_PROTOCOL_FROM_BITMASK(
            ipoque_struct->callback_buffer[a].excluded_protocol_bitmask,
            IPOQUE_PROTOCOL_UNKNOWN);
        ...
        IPOQUE_DEL_PROTOCOL_FROM_BITMASK(
            ipoque_struct->generic_http_packet_bitmask,
            IPOQUE_PROTOCOL_UNKNOWN);
    ...
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_STUN) != 0
#ifdef IPOQUE_PROTOCOL_RTP
        || IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                              IPOQUE_PROTOCOL_RTP) != 0
#endif
    ) {
    ...
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
        ...
        ipoque_struct->callback_buffer[a].detection_feature =
            IPOQUE_SELECT_DETECTION_WITH_REAL_PROTOCOL;
    ...
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_BITTORRENT) != 0) {
        ipoque_struct->callback_buffer[a].func = ipoque_search_bittorrent;
        ipoque_struct->callback_buffer[a].ipq_selection_bitmask =
            IPQ_SELECTION_BITMASK_PROTOCOL_V4_V6_TCP_OR_UDP;
    ...
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
        ...
        IPOQUE_SAVE_AS_BITMASK(
            ipoque_struct->callback_buffer[a].excluded_protocol_bitmask,
            IPOQUE_PROTOCOL_FASTTRACK);
        a++;
    }
#endif
#ifdef IPOQUE_PROTOCOL_GNUTELLA
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_GNUTELLA) != 0) {
    ...
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(
            *detection_bitmask, IPOQUE_PROTOCOL_DIRECTCONNECT) != 0) {
    ...
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(
            *detection_bitmask, IPOQUE_PROTOCOL_UNENCRYPED_JABBER) != 0) {
    ...
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
        ...
        IPOQUE_SAVE_AS_BITMASK(
            ipoque_struct->callback_buffer[a].excluded_protocol_bitmask,
            IPOQUE_PROTOCOL_PANDO);

        a++;
    }
#endif
#if defined(IPOQUE_PROTOCOL_IPSEC) || defined(IPOQUE_PROTOCOL_GRE) ||     \
    defined(IPOQUE_PROTOCOL_ICMP) || defined(IPOQUE_PROTOCOL_IGMP) ||     \
    defined(IPOQUE_PROTOCOL_EGP) || defined(IPOQUE_PROTOCOL_SCTP) ||      \
    defined(IPOQUE_PROTOCOL_OSPF) || defined(IPOQUE_PROTOCOL_IP_IN_IP) || \
    defined(IPOQUE_PROTOCOL_ICMPV6)
    ...
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_IAX) != 0) {
        ipoque_struct->callback_buffer[a].func = ipoque_search_iax;
        ipoque_struct->callback_buffer[a].ipq_selection_bitmask =
            IPQ_SELECTION_BITMASK_PROTOCOL_V4_V6_UDP_WITH_PAYLOAD;
    ...
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
        ...
        IPOQUE_SAVE_AS_BITMASK(
            ipoque_struct->callback_buffer[a].excluded_protocol_bitmask,
            IPOQUE_PROTOCOL_POPO);
        a++;
    }
#endif
#ifdef IPOQUE_PROTOCOL_THUNDER
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_THUNDER) != 0) {
        ...
        IPOQUE_SAVE_AS_BITMASK(
            ipoque_struct->callback_buffer[a].excluded_protocol_bitmask,
            IPOQUE_PROTOCOL_THUNDER);
        a++;
    }
#endif
#ifdef IPOQUE_PROTOCOL_VNC
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_VNC) != 0) {
    ...
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
        ...
        IPOQUE_SAVE_AS_BITMASK(
            ipoque_struct->callback_buffer[a].excluded_protocol_bitmask,
            IPOQUE_PROTOCOL_DHCP);
        a++;
    }
#endif
#ifdef IPOQUE_PROTOCOL_I23V5
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_I23V5) != 0) {
        ...
        IPOQUE_SAVE_AS_BITMASK(
            ipoque_struct->callback_buffer[a].excluded_protocol_bitmask,
            IPOQUE_PROTOCOL_I23V5);
        a++;
    }
#endif
#ifdef IPOQUE_PROTOCOL_SOCRATES
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_SOCRATES) != 0) {
    ...
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(
            *detection_bitmask, IPOQUE_PROTOCOL_HTTP_APPLICATION_ACTIVESYNC) !=
        0) {
    ...
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(
            *detection_bitmask, IPOQUE_PROTOCOL_WORLDOFWARCRAFT) != 0) {
    ...
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
        ...
        IPOQUE_SAVE_AS_BITMASK(
            ipoque_struct->callback_buffer[a].excluded_protocol_bitmask,
            IPOQUE_PROTOCOL_SECONDLIFE);
        a++;
    }
#endif
#ifdef IPOQUE_PROTOCOL_PCANYWHERE
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_PCANYWHERE) != 0) {
        ...
        IPOQUE_SAVE_AS_BITMASK(
            ipoque_struct->callback_buffer[a].excluded_protocol_bitmask,
            IPOQUE_PROTOCOL_PCANYWHERE);
        a++;
    }
#endif
#ifdef IPOQUE_PROTOCOL_SNMP
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_SNMP) != 0) {
        ...
        IPOQUE_SAVE_AS_BITMASK(
            ipoque_struct->callback_buffer[a].excluded_protocol_bitmask,
            IPOQUE_PROTOCOL_SNMP);
        a++;
    }
#endif
#ifdef IPOQUE_PROTOCOL_KONTIKI
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_KONTIKI) != 0) {
    ...
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(
            *detection_bitmask, IPOQUE_PROTOCOL_HTTP_APPLICATION_VEOHTV) != 0) {
    ...
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
        ...
        IPOQUE_SAVE_AS_BITMASK(
            ipoque_struct->callback_buffer[a].excluded_protocol_bitmask,
            IPOQUE_PROTOCOL_KERBEROS);
        a++;
    }
#endif
#ifdef IPOQUE_PROTOCOL_OPENFT
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_OPENFT) != 0) {
        ...
        IPOQUE_SAVE_AS_BITMASK(
            ipoque_struct->callback_buffer[a].excluded_protocol_bitmask,
            IPOQUE_PROTOCOL_OPENFT);
        a++;
    }
#endif
#ifdef IPOQUE_PROTOCOL_SYSLOG
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_SYSLOG) != 0) {
    ...
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(
            *detection_bitmask, IPOQUE_PROTOCOL_DIRECT_DOWNLOAD_LINK) != 0) {
        ipoque_struct->callback_buffer[a].func =
            ipoque_search_direct_download_link_tcp;
        ipoque_struct->callback_buffer[a].ipq_selection_bitmask =
            IPQ_SELECTION_BITMASK_PROTOCOL_V4_V6_TCP_WITH_PAYLOAD;
    ...
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
        ...
        IPOQUE_SAVE_AS_BITMASK(
            ipoque_struct->callback_buffer[a].excluded_protocol_bitmask,
            IPOQUE_PROTOCOL_MSSQL);
        a++;
    }
#endif
#ifdef IPOQUE_PROTOCOL_PPTP
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_PPTP) != 0) {
        ...
        IPOQUE_SAVE_AS_BITMASK(
            ipoque_struct->callback_buffer[a].excluded_protocol_bitmask,
            IPOQUE_PROTOCOL_PPTP);
        a++;
    }
#endif
#ifdef IPOQUE_PROTOCOL_STEALTHNET
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_STEALTHNET) != 0) {
        ...
        IPOQUE_SAVE_AS_BITMASK(
            ipoque_struct->callback_buffer[a].excluded_protocol_bitmask,
            IPOQUE_PROTOCOL_STEALTHNET);
        a++;
    }
#endif
#ifdef IPOQUE_PROTOCOL_DHCPV6
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_DHCPV6) != 0) {
        ipoque_struct->callback_buffer[a].func = ipoque_search_dhcpv6_udp;
        ipoque_struct->callback_buffer[a].ipq_selection_bitmask =
            IPQ_SELECTION_BITMASK_PROTOCOL_V6_UDP_WITH_PAYLOAD;
        ...
        IPOQUE_SAVE_AS_BITMASK(
            ipoque_struct->callback_buffer[a].excluded_protocol_bitmask,
            IPOQUE_PROTOCOL_DHCPV6);
        a++;
    }
#endif
#ifdef IPOQUE_PROTOCOL_MEEBO
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_MEEBO) != 0) {
        ...
        IPOQUE_SAVE_AS_BITMASK(
            ipoque_struct->callback_buffer[a].excluded_protocol_bitmask,
            IPOQUE_PROTOCOL_MEEBO);
        a++;
    }
#endif
#ifdef IPOQUE_PROTOCOL_AFP
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_AFP) != 0) {
    ...
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
        ...
        IPOQUE_SAVE_AS_BITMASK(
            ipoque_struct->callback_buffer[a].excluded_protocol_bitmask,
            IPOQUE_PROTOCOL_AIMINI);
        a++;
    }
#endif
#ifdef IPOQUE_PROTOCOL_FLORENSIA
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_FLORENSIA) != 0) {
        ...
        IPOQUE_SAVE_AS_BITMASK(
            ipoque_struct->callback_buffer[a].excluded_protocol_bitmask,
            IPOQUE_PROTOCOL_FLORENSIA);
        a++;
    }
#endif
#ifdef IPOQUE_PROTOCOL_MAPLESTORY
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_MAPLESTORY) != 0) {
        ...
        IPOQUE_SAVE_AS_BITMASK(
            ipoque_struct->callback_buffer[a].excluded_protocol_bitmask,
            IPOQUE_PROTOCOL_MAPLESTORY);
        a++;
    }
#endif
#ifdef IPOQUE_PROTOCOL_DOFUS
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_DOFUS) != 0) {
        ...
        IPOQUE_SAVE_AS_BITMASK(
            ipoque_struct->callback_buffer[a].excluded_protocol_bitmask,
            IPOQUE_PROTOCOL_DOFUS);
        a++;
    }
#endif
#ifdef IPOQUE_PROTOCOL_WORLD_OF_KUNG_FU
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(
            *detection_bitmask, IPOQUE_PROTOCOL_WORLD_OF_KUNG_FU) != 0) {
    ...
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
        ...
        IPOQUE_SAVE_AS_BITMASK(
            ipoque_struct->callback_buffer[a].excluded_protocol_bitmask,
            IPOQUE_PROTOCOL_FIESTA);
        a++;
    }
#endif
#ifdef IPOQUE_PROTOCOL_CROSSFIRE
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(*detection_bitmask,
                                           IPOQUE_PROTOCOL_CROSSFIRE) != 0) {
        ipoque_struct->callback_buffer[a].func =
            ipoque_search_crossfire_tcp_udp;
        ipoque_struct->callback_buffer[a].ipq_selection_bitmask =
            IPQ_SELECTION_BITMASK_PROTOCOL_V4_V6_TCP_OR_UDP_WITH_PAYLOAD_WITHOUT_RETRANSMISSION;
    ...
    for (a = 0; a < ipoque_struct->callback_buffer_size; a++) {
        if ((ipoque_struct->callback_buffer[a].ipq_selection_bitmask &
             (IPQ_SELECTION_BITMASK_PROTOCOL_INT_TCP |
              IPQ_SELECTION_BITMASK_PROTOCOL_INT_TCP_OR_UDP |
              IPQ_SELECTION_BITMASK_PROTOCOL_COMPLETE_TRAFFIC)) != 0) {
            IPQ_LOG(
                IPOQUE_PROTOCOL_UNKNOWN, ipoque_struct, IPQ_LOG_DEBUG,
                "callback_buffer_tcp_payload, adding buffer %u as entry %u\n",
                a, ipoque_struct->callback_buffer_size_tcp_payload);

            memcpy(&ipoque_struct->callback_buffer_tcp_payload
                        [ipoque_struct->callback_buffer_size_tcp_payload],
                   &ipoque_struct->callback_buffer[a],
                   sizeof(struct ipq_call_function_struct));
            ipoque_struct->callback_buffer_size_tcp_payload++;

            if ((ipoque_struct->callback_buffer[a].ipq_selection_bitmask &
                 IPQ_SELECTION_BITMASK_PROTOCOL_HAS_PAYLOAD) == 0) {
                IPQ_LOG(IPOQUE_PROTOCOL_UNKNOWN, ipoque_struct, IPQ_LOG_DEBUG,
                        "callback_buffer_tcp_no_payload, additional adding "
                        "buffer %u to no_payload process\n",
                        a);

                memcpy(
                    &ipoque_struct->callback_buffer_tcp_no_payload
    ...
    for (a = 0; a < ipoque_struct->callback_buffer_size; a++) {
        if ((ipoque_struct->callback_buffer[a].ipq_selection_bitmask &
            ...
            memcpy(&ipoque_struct->callback_buffer_udp
    ...
    for (a = 0; a < ipoque_struct->callback_buffer_size; a++) {
        if ((ipoque_struct->callback_buffer[a].ipq_selection_bitmask &
             (IPQ_SELECTION_BITMASK_PROTOCOL_INT_TCP |
              IPQ_SELECTION_BITMASK_PROTOCOL_INT_UDP |
              IPQ_SELECTION_BITMASK_PROTOCOL_INT_TCP_OR_UDP)) == 0 ||
            (ipoque_struct->callback_buffer[a].ipq_selection_bitmask &
             IPQ_SELECTION_BITMASK_PROTOCOL_COMPLETE_TRAFFIC) != 0) {
            IPQ_LOG(IPOQUE_PROTOCOL_UNKNOWN, ipoque_struct, IPQ_LOG_DEBUG,
                    "callback_buffer_size_non_tcp_udp, adding buffer %u\n", a);

            memcpy(&ipoque_struct->callback_buffer_non_tcp_udp
 ...
 */
static int ipq_handle_ipv6_extension_headers(
    struct ipoque_detection_module_struct *ipoque_struct, const u8 **l4ptr,
    u16 *l4len, u8 *nxt_hdr) {
    while ((*nxt_hdr == 0 || *nxt_hdr == 43 || *nxt_hdr == 44 ||
            *nxt_hdr == 60 || *nxt_hdr == 135 || *nxt_hdr == 59)) {
        u16 ehdr_len;
        ...
        // fragment extension header has fixed size of 8 bytes and the first
        // byte is the next header type
        if (*nxt_hdr == 44) {
            if (*l4len < 8) {
                return 1;
            }
        ...
        // and one byte for the extension header length in 8 byte steps minus
        // the first 8 bytes
        ehdr_len = (*l4ptr)[1];
        ehdr_len *= 8;
        ehdr_len += 8;
...
static u8 ipoque_iph_is_valid_and_not_fragmented(const struct iphdr *iph,
                                                 const u16 ipsize) {
    if (ipsize < iph->ihl * 4 || ipsize < ntohs(iph->tot_len) ||
...
static u8 ipoque_detection_get_l4_internal(
    struct ipoque_detection_module_struct *ipoque_struct, const u8 *l3,
    u16 l3_len, const u8 **l4_return, u16 *l4_len_return,
    ...
    if (l3 == NULL || l3_len < sizeof(struct iphdr)) return 1;
    ...
    if ((flags & IPOQUE_DETECTION_ONLY_IPV6) && iph != NULL) {
        IPQ_LOG(IPOQUE_PROTOCOL_UNKNOWN, ipoque_struct, IPQ_LOG_DEBUG,
                "ipv4 header found but excluded by flag\n");
        return 1;
    }
#ifdef IPOQUE_DETECTION_SUPPORT_IPV6
    else if ((flags & IPOQUE_DETECTION_ONLY_IPV4) && iph_v6 != NULL) {
        IPQ_LOG(IPOQUE_PROTOCOL_UNKNOWN, ipoque_struct, IPQ_LOG_DEBUG,
                "ipv6 header found but excluded by flag\n");
        return 1;
    }
#endif
    ...
    if (iph != NULL && ipoque_iph_is_valid_and_not_fragmented(iph, l3_len)) {
...
#ifdef IPOQUE_DETECTION_SUPPORT_IPV6
    else if (iph_v6 != NULL && (l3_len - sizeof(struct ipq_ipv6hdr)) >=
                                   ntohs(iph_v6->payload_len)) {
        ...
        if (ipq_handle_ipv6_extension_headers(ipoque_struct, &l4ptr, &l4len,
                                              &l4protocol) != 0) {
            return 1;
        }
...
ATTRIBUTE_ALWAYS_INLINE static inline void ipoque_apply_flow_protocol_to_packet(
    struct ipoque_flow_struct *flow, struct ipoque_packet_struct *packet) {
    memcpy(&packet->detected_protocol_stack[0],
           &flow->detected_protocol_stack[0],
           sizeof(packet->detected_protocol_stack));
#if IPOQUE_PROTOCOL_HISTORY_SIZE > 1
    memcpy(&packet->protocol_stack_info, &flow->protocol_stack_info,
           sizeof(packet->protocol_stack_info));
#endif
}

static int ipq_init_packet_header(
    struct ipoque_detection_module_struct *ipoque_struct,
    ...
    if (decaps_iph->version == 4 && decaps_iph->ihl >= 5) {
        IPQ_LOG(IPOQUE_PROTOCOL_UNKNOWN, ipoque_struct, IPQ_LOG_DEBUG,
             ...
             (ipoque_struct->ip_version_limit & IPOQUE_DETECTION_ONLY_IPV4) ==
                 0) {
        IPQ_LOG(IPOQUE_PROTOCOL_UNKNOWN, ipoque_struct, IPQ_LOG_DEBUG,
                "ipv6 header\n");
        ipoque_struct->packet.iphv6 =
            (struct ipq_ipv6hdr *)ipoque_struct->packet.iph;
    ...
    l4_result =
        ipoque_detection_get_l4_internal(ipoque_struct, (const u8 *)decaps_iph,
                                         l3len, &l4ptr, &l4len, &l4protocol, 0);
    ...
    /* tcp / udp detection */
    if (l4protocol == 6 /* TCP */ &&
        ipoque_struct->packet.l4_packet_len >= 20 /* min size of tcp */) {
        /* tcp */
        ipoque_struct->packet.tcp = (struct tcphdr *)l4ptr;

        if (ipoque_struct->packet.l4_packet_len >=
            ipoque_struct->packet.tcp->doff * 4) {
            ipoque_struct->packet.payload_packet_len =
                ipoque_struct->packet.l4_packet_len -
                ipoque_struct->packet.tcp->doff * 4;
            ipoque_struct->packet.actual_payload_len =
                ipoque_struct->packet.payload_packet_len;
            ipoque_struct->packet.payload =
                ((u8 *)ipoque_struct->packet.tcp) +
                (ipoque_struct->packet.tcp->doff * 4);
            ...
            if (ipoque_struct->packet.tcp->syn != 0 &&
                ...
                ipoque_struct->flow->detected_protocol_stack[0] ==
                    IPOQUE_PROTOCOL_UNKNOWN) {
                memset(ipoque_struct->flow, 0, sizeof(*(ipoque_struct->flow)));

                IPQ_LOG(IPOQUE_PROTOCOL_UNKNOWN, ipoque_struct, IPQ_LOG_DEBUG,
                        "%s:%u: tcp syn packet for unknown protocol, reset "
                        "detection state\n",
    ...
    } else if (l4protocol == 17 /* udp */ &&
               ipoque_struct->packet.l4_packet_len >= 8 /* size of udp */) {
        ipoque_struct->packet.udp = (struct udphdr *)l4ptr;
        ipoque_struct->packet.payload_packet_len =
            ipoque_struct->packet.l4_packet_len - 8;
...
static inline void ipoque_connection_tracking(
    struct ipoque_detection_module_struct *ipoque_struct) {
    ...
    if (iph != NULL && iph->saddr < iph->daddr) packet->packet_direction = 1;

#ifdef IPOQUE_DETECTION_SUPPORT_IPV6
    if (iphv6 != NULL &&
        IPOQUE_COMPARE_IPV6_ADDRESS_STRUCTS(&iphv6->saddr, &iphv6->daddr) != 0)
    ...
    if (tcph != NULL) {
        ...
        if (tcph->syn != 0 && tcph->ack == 0 && flow->l4.tcp.seen_syn == 0 &&
            flow->l4.tcp.seen_syn_ack == 0 && flow->l4.tcp.seen_ack == 0) {
        ...
        if (tcph->syn == 0 && tcph->ack == 1 && flow->l4.tcp.seen_syn == 1 &&
            flow->l4.tcp.seen_syn_ack == 1 && flow->l4.tcp.seen_ack == 0) {
            flow->l4.tcp.seen_ack = 1;
        }
        if ((flow->next_tcp_seq_nr[0] == 0 && flow->next_tcp_seq_nr[1] == 0) ||
            (proxy_enabled && (flow->next_tcp_seq_nr[0] == 0 ||
                               flow->next_tcp_seq_nr[1] == 0))) {
            /* initalize tcp sequence counters */
            /* the ack flag needs to be set to get valid sequence numbers from
             * the other direction. Usually it will catch the second packet
             * syn+ack but it works also for asymmetric traffic where it will
            ...
            if (tcph->ack != 0) {
                flow->next_tcp_seq_nr[ipoque_struct->packet.packet_direction] =
                    ntohl(tcph->seq) +
                    (tcph->syn ? 1 : packet->payload_packet_len);
                if (!proxy_enabled) {
                    flow->next_tcp_seq_nr[1 - ipoque_struct->packet
                                                  .packet_direction] =
                        ntohl(tcph->ack_seq);
                }
            }
            ...
            if (((u32)(ntohl(tcph->seq) -
                ...
                if ((flow->next_tcp_seq_nr[packet->packet_direction] -
                         ntohl(tcph->seq) <
                     packet->payload_packet_len)) {
                    /* num_retried_bytes actual_payload_len hold info about the
                       partial retry analyzer which require this info can make
                       use of this info Other analyzer can use
                       packet->payload_packet_len */
                    packet->num_retried_bytes =
                        flow->next_tcp_seq_nr[packet->packet_direction] -
                        ntohl(tcph->seq);
                    packet->actual_payload_len =
                        packet->payload_packet_len - packet->num_retried_bytes;
                    flow->next_tcp_seq_nr[packet->packet_direction] =
                        ntohl(tcph->seq) + packet->payload_packet_len;
                }
            }
            /*normal path
               actual_payload_len is initialized to payload_packet_len during
               tcp header parsing itself. It will be changed only in case of
               retransmission */
            else {
                packet->num_retried_bytes = 0;
                flow->next_tcp_seq_nr[packet->packet_direction] =
    ...
    if (flow->packet_counter < MAX_PACKET_COUNTER &&
        packet->payload_packet_len) {
        flow->packet_counter++;
    }

    if (flow->packet_direction_counter[packet->packet_direction] <
            MAX_PACKET_COUNTER &&
        packet->payload_packet_len) {
        flow->packet_direction_counter[packet->packet_direction]++;
    }

    if (flow->byte_counter[packet->packet_direction] +
            packet->payload_packet_len >
...
unsigned int ipoque_detection_process_packet(
    struct ipoque_detection_module_struct *ipoque_struct, void *flow,
    ...
    if (ipoque_struct->packet.iph != NULL) {
        ipq_selection_packet |= IPQ_SELECTION_BITMASK_PROTOCOL_IP |
                                IPQ_SELECTION_BITMASK_PROTOCOL_IPV4_OR_IPV6;
    }
    if (ipoque_struct->packet.tcp != NULL) {
        ipq_selection_packet |= (IPQ_SELECTION_BITMASK_PROTOCOL_INT_TCP |
                                 IPQ_SELECTION_BITMASK_PROTOCOL_INT_TCP_OR_UDP);
    }
    if (ipoque_struct->packet.udp != NULL) {
        ipq_selection_packet |= (IPQ_SELECTION_BITMASK_PROTOCOL_INT_UDP |
                                 IPQ_SELECTION_BITMASK_PROTOCOL_INT_TCP_OR_UDP);
    }
    ...
    if (ipoque_struct->packet.iphv6 != NULL) {
        ipq_selection_packet |= IPQ_SELECTION_BITMASK_PROTOCOL_IPV6 |
                                IPQ_SELECTION_BITMASK_PROTOCOL_IPV4_OR_IPV6;
    }
#endif /* IPOQUE_DETECTION_SUPPORT_IPV6 */

    IPOQUE_SAVE_AS_BITMASK(detection_bitmask,
                           ipoque_struct->packet.detected_protocol_stack[0]);

    if (ipoque_struct->flow != NULL && ipoque_struct->packet.tcp != NULL) {
        if (ipoque_struct->packet.payload_packet_len != 0) {
            for (a = 0; a < ipoque_struct->callback_buffer_size_tcp_payload;
                 a++) {
                if ((ipoque_struct->callback_buffer_tcp_payload[a]
                         .ipq_selection_bitmask &
                     ipq_selection_packet) ==
                        ipoque_struct->callback_buffer_tcp_payload[a]
                            .ipq_selection_bitmask &&
                    IPOQUE_BITMASK_COMPARE(
                        ipoque_struct->flow->excluded_protocol_bitmask,
                        ipoque_struct->callback_buffer_tcp_payload[a]
                            .excluded_protocol_bitmask) == 0 &&
                    IPOQUE_BITMASK_COMPARE(
                        ipoque_struct->callback_buffer_tcp_payload[a]
                            .detection_bitmask,
                        detection_bitmask) != 0) {
                    ipoque_struct->callback_buffer_tcp_payload[a].func(
                        ipoque_struct);
                }
            }
            if (di)
                if (msiCheck(ipoque_struct->packet.payload,
                             ipoque_struct->packet.payload_packet_len,
                             PACKET_TCP)) {
                    printf("%s\n", msiLog());
                }
            ...
            for (a = 0; a < ipoque_struct->callback_buffer_size_tcp_no_payload;
                 a++) {
                if ((ipoque_struct->callback_buffer_tcp_no_payload[a]
                         .ipq_selection_bitmask &
                     ipq_selection_packet) ==
                        ipoque_struct->callback_buffer_tcp_no_payload[a]
                            .ipq_selection_bitmask &&
                    IPOQUE_BITMASK_COMPARE(
                        ipoque_struct->flow->excluded_protocol_bitmask,
                        ipoque_struct->callback_buffer_tcp_no_payload[a]
                    ...
                    IPOQUE_BITMASK_COMPARE(
                        ipoque_struct->callback_buffer_tcp_no_payload[a]
                            .detection_bitmask,
                        detection_bitmask) != 0) {
                    ipoque_struct->callback_buffer_tcp_no_payload[a].func(
                        ipoque_struct);
                }
            }
        }
    } else if (ipoque_struct->flow != NULL &&
               ipoque_struct->packet.udp != NULL) {
        for (a = 0; a < ipoque_struct->callback_buffer_size_udp; a++) {
            if ((ipoque_struct->callback_buffer_udp[a].ipq_selection_bitmask &
                 ipq_selection_packet) == ipoque_struct->callback_buffer_udp[a]
                                              .ipq_selection_bitmask &&
                IPOQUE_BITMASK_COMPARE(
                    ipoque_struct->flow->excluded_protocol_bitmask,
                    ipoque_struct->callback_buffer_udp[a]
                        .excluded_protocol_bitmask) == 0 &&
                IPOQUE_BITMASK_COMPARE(
                    ipoque_struct->callback_buffer_udp[a].detection_bitmask,
                    detection_bitmask) != 0) {
        ...
        for (a = 0; a < ipoque_struct->callback_buffer_size_non_tcp_udp; a++) {
            if ((ipoque_struct->callback_buffer_non_tcp_udp[a]
                     .ipq_selection_bitmask &
                 ipq_selection_packet) ==
                    ipoque_struct->callback_buffer_non_tcp_udp[a]
                        .ipq_selection_bitmask &&
                (ipoque_struct->flow == NULL ||
                 IPOQUE_BITMASK_COMPARE(
                     ipoque_struct->flow->excluded_protocol_bitmask,
                ...
                IPOQUE_BITMASK_COMPARE(
                    ipoque_struct->callback_buffer_non_tcp_udp[a]
                        .detection_bitmask,
                    detection_bitmask) != 0) {
                ipoque_struct->callback_buffer_non_tcp_udp[a].func(
                    ipoque_struct);
            }
        }
    }
    ...
    if (IPOQUE_COMPARE_PROTOCOL_TO_BITMASK(ipoque_struct->detection_bitmask,
                                           a) == 0)
...
static u8 ipoque_detection_build_key_internal(
    struct ipoque_detection_module_struct *ipoque_struct, const u8 *l3,
    u16 l3_len, const u8 *l4, u16 l4_len, u8 l4_protocol,
    struct ipoque_unique_flow_ipv4_and_6_struct *key_return, u8 *dir_return,
    u32 flags) {
    const struct iphdr *iph = NULL;
    u8 swapped = 0;

    if (key_return == NULL || l3 == NULL) return 1;

    if (l3_len < sizeof(*iph)) return 1;

    iph = (const struct iphdr *)l3;

    if (iph->version == 4 &&
        ((iph->ihl * 4) > l3_len || l3_len < ntohs(iph->tot_len) ||
         (iph->frag_off & htons(0x1FFF)) != 0)) {
        return 1;
    }
    ...
    } else if (key_return->protocol == 17 /* UDP */ &&
...
u32 ipq_bytestream_to_number(const u8 *str, u16 max_chars_to_read,
                             u16 *bytes_read) {
    u32 val;
    val = 0;
...
u32 ipq_bytestream_dec_or_hex_to_number(const u8 *str, u16 max_chars_to_read,
                                        u16 *bytes_read) {
    u32 val;
    val = 0;
...
u64 ipq_bytestream_to_number64(const u8 *str, u16 max_chars_to_read,
                               u16 *bytes_read) {
    u64 val;
    val = 0;
    // cancel if eof, ' ' or line end chars are reached
...
u64 ipq_bytestream_dec_or_hex_to_number64(const u8 *str, u16 max_chars_to_read,
                                          u16 *bytes_read) {
    u64 val;
    val = 0;
    if (max_chars_to_read <= 2 || str[0] != '0' || str[1] != 'x') {
...
u32 ipq_bytestream_to_ipv4(const u8 *str, u16 max_chars_to_read,
                           u16 *bytes_read) {
    u32 val;
    u16 read = 0;
    u16 oldread;
    ...
    oldread = read;
    c = ipq_bytestream_to_number(&str[read], max_chars_to_read - read, &read);
    if (c > 255 || oldread == read || max_chars_to_read == read) return 0;
    val = val + c;
...
/* internal function for every detection to parse one packet and to increase the
 * info buffer */
void ipq_parse_packet_line_info(
    struct ipoque_detection_module_struct *ipoque_struct) {
    struct ipoque_packet_struct *packet = &ipoque_struct->packet;
    u32 a;
    u16 end = packet->payload_packet_len - 1;
    if (packet->packet_lines_parsed_complete != 0) return;
    ...
    for (a = 0; a < end; a++) {
        if (get_u16(packet->payload, a) == ntohs(0x0d0a)) {
            ...
            if (packet->parsed_lines == 0 &&
                packet->line[0].len >= IPQ_STATICSTRING_LEN("HTTP/1.1 200 ") &&
                memcmp(packet->line[0].ptr, "HTTP/1.",
                       IPQ_STATICSTRING_LEN("HTTP/1.")) == 0 &&
                packet->line[0].ptr[IPQ_STATICSTRING_LEN("HTTP/1.1 ")] > '0' &&
                packet->line[0].ptr[IPQ_STATICSTRING_LEN("HTTP/1.1 ")] < '6') {
                packet->http_response.ptr =
                    &packet->line[0].ptr[IPQ_STATICSTRING_LEN("HTTP/1.1 ")];
                packet->http_response.len =
                    packet->line[0].len - IPQ_STATICSTRING_LEN("HTTP/1.1 ");
                IPQ_LOG(IPOQUE_PROTOCOL_UNKNOWN, ipoque_struct, IPQ_LOG_DEBUG,
                        "ipq_parse_packet_line_info: HTTP response parsed: "
                        "\"%.*s\"\n",
                        packet->http_response.len, packet->http_response.ptr);
            }
            if (packet->line[packet->parsed_lines].len >
                    IPQ_STATICSTRING_LEN("Server:") + 1 &&
                memcmp(packet->line[packet->parsed_lines].ptr,
                       "Server:", IPQ_STATICSTRING_LEN("Server:")) == 0) {
                // some stupid clients omit a space and place the servername
                // directly after the colon
                if (packet->line[packet->parsed_lines]
                        .ptr[IPQ_STATICSTRING_LEN("Server:")] == ' ') {
                    packet->server_line.ptr =
                        &packet->line[packet->parsed_lines]
                             .ptr[IPQ_STATICSTRING_LEN("Server:") + 1];
                    ...
                    packet->server_line.len =
                        packet->line[packet->parsed_lines].len -
                        IPQ_STATICSTRING_LEN("Server:");
                }
            }

            if (packet->line[packet->parsed_lines].len > 6 &&
                memcmp(packet->line[packet->parsed_lines].ptr, "Host:", 5) ==
                    0) {
                // some stupid clients omit a space and place the hostname
                // directly after the colon
                if (packet->line[packet->parsed_lines].ptr[5] == ' ') {
                    packet->host_line.ptr =
                        &packet->line[packet->parsed_lines].ptr[6];
                    packet->host_line.len =
                        packet->line[packet->parsed_lines].len - 6;
                } else {
                    packet->host_line.ptr =
                        &packet->line[packet->parsed_lines].ptr[5];
                    packet->host_line.len =
            ...
            if (packet->line[packet->parsed_lines].len > 14 &&
                ...
                packet->content_line.ptr =
                    &packet->line[packet->parsed_lines].ptr[14];
            ...
            if (packet->line[packet->parsed_lines].len > 13 &&
                memcmp(packet->line[packet->parsed_lines].ptr,
                       "content-type:", 13) == 0) {
                packet->content_line.ptr =
                    &packet->line[packet->parsed_lines].ptr[13];
                packet->content_line.len =
                    packet->line[packet->parsed_lines].len - 13;
            }

            if (packet->line[packet->parsed_lines].len > 8 &&
                memcmp(packet->line[packet->parsed_lines].ptr, "Accept: ", 8) ==
                    0) {
                packet->accept_line.ptr =
                    &packet->line[packet->parsed_lines].ptr[8];
            ...
            if (packet->line[packet->parsed_lines].len > 9 &&
                ...
                packet->referer_line.ptr =
                    &packet->line[packet->parsed_lines].ptr[9];
            ...
            if (packet->line[packet->parsed_lines].len > 12 &&
                ...
                packet->user_agent_line.ptr =
                    &packet->line[packet->parsed_lines].ptr[12];
            ...
            if (packet->line[packet->parsed_lines].len > 18 &&
                ...
                packet->http_encoding.ptr =
                    &packet->line[packet->parsed_lines].ptr[18];
                packet->http_encoding.len =
                    packet->line[packet->parsed_lines].len - 18;
            }

            if (packet->line[packet->parsed_lines].len > 19 &&
                memcmp(packet->line[packet->parsed_lines].ptr,
                       "Transfer-Encoding: ", 19) == 0) {
                packet->http_transfer_encoding.ptr =
                    &packet->line[packet->parsed_lines].ptr[19];
                packet->http_transfer_encoding.len =
            ...
            if (packet->line[packet->parsed_lines].len > 16 &&
                ...
                packet->http_contentlen.ptr =
                    &packet->line[packet->parsed_lines].ptr[16];
                packet->http_contentlen.len =
                    packet->line[packet->parsed_lines].len - 16;
            }
            if (packet->line[packet->parsed_lines].len > 8 &&
                memcmp(packet->line[packet->parsed_lines].ptr, "Cookie: ", 8) ==
                    0) {
                packet->http_cookie.ptr =
                    &packet->line[packet->parsed_lines].ptr[8];
                packet->http_cookie.len =
                    packet->line[packet->parsed_lines].len - 8;
            }
            if (packet->line[packet->parsed_lines].len > 16 &&
                memcmp(packet->line[packet->parsed_lines].ptr,
                       "X-Session-Type: ", 16) == 0) {
                packet->http_x_session_type.ptr =
                    &packet->line[packet->parsed_lines].ptr[16];
                packet->http_x_session_type.len =
                    packet->line[packet->parsed_lines].len - 16;
            }
            ...
            if (packet->parsed_lines >=
                (IPOQUE_MAX_PARSE_LINES_PER_PACKET - 1)) {
                return;
            }
...
void ipq_parse_packet_line_info_unix(
    struct ipoque_detection_module_struct *ipoque_struct) {
    struct ipoque_packet_struct *packet = &ipoque_struct->packet;
    u32 a;
    u16 end = packet->payload_packet_len;
    if (packet->packet_unix_lines_parsed_complete != 0) return;
    ...
    for (a = 0; a < end; a++) {
        if (packet->payload[a] == 0x0a) {
            packet->unix_line[packet->parsed_unix_lines].len =
                ((unsigned long)&packet->payload[a]) -
                ((unsigned long)packet->unix_line[packet->parsed_unix_lines]
                     .ptr);

            if (packet->parsed_unix_lines >=
                (IPOQUE_MAX_PARSE_LINES_PER_PACKET - 1)) {
                break;
            }

            packet->parsed_unix_lines++;
            packet->unix_line[packet->parsed_unix_lines].ptr =
                &packet->payload[a + 1];
            packet->unix_line[packet->parsed_unix_lines].len = 0;
...
u16 ipoque_check_for_email_address(
    struct ipoque_detection_module_struct *ipoque_struct, u16 counter) {
    struct ipoque_packet_struct *packet = &ipoque_struct->packet;

    IPQ_LOG(IPOQUE_PROTOCOL_MSN, ipoque_struct, IPQ_LOG_DEBUG,
            "called ipoque_check_for_email_address\n");
    ...
    if (packet->payload_packet_len > counter &&
        ...
        while (packet->payload_packet_len > counter &&
               ((packet->payload[counter] >= 'a' &&
                 packet->payload[counter] <= 'z') ||
                (packet->payload[counter] >= 'A' &&
                 packet->payload[counter] <= 'Z') ||
                (packet->payload[counter] >= '0' &&
                 packet->payload[counter] <= '9') ||
                packet->payload[counter] == '-' ||
                packet->payload[counter] == '_' ||
                packet->payload[counter] == '.')) {
            IPQ_LOG(IPOQUE_PROTOCOL_MSN, ipoque_struct, IPQ_LOG_DEBUG,
                    "further letter\n");
            counter++;
                ...
                while (packet->payload_packet_len > counter &&
                    ...
                    if (packet->payload_packet_len > counter &&
                        ...
                        if (packet->payload_packet_len > counter + 1 &&
                            ((packet->payload[counter] >= 'a' &&
                              packet->payload[counter] <= 'z') &&
                             (packet->payload[counter + 1] >= 'a' &&
                              packet->payload[counter + 1] <= 'z'))) {
                            IPQ_LOG(IPOQUE_PROTOCOL_MSN, ipoque_struct,
                                    IPQ_LOG_DEBUG, "two letters\n");
                            counter += 2;
                            if (packet->payload_packet_len > counter &&
                                (packet->payload[counter] == ' ' ||
                                 packet->payload[counter] == ';')) {
                                IPQ_LOG(IPOQUE_PROTOCOL_MSN, ipoque_struct,
                                        IPQ_LOG_DEBUG, "whitespace1\n");
                                return counter;
                            } else if (packet->payload_packet_len > counter &&
                                       packet->payload[counter] >= 'a' &&
                                       packet->payload[counter] <= 'z') {
                                IPQ_LOG(IPOQUE_PROTOCOL_MSN, ipoque_struct,
                                        IPQ_LOG_DEBUG, "one letter\n");
                                counter++;
                                if (packet->payload_packet_len > counter &&
                                    (packet->payload[counter] == ' ' ||
                                     packet->payload[counter] == ';')) {
                                    IPQ_LOG(IPOQUE_PROTOCOL_MSN, ipoque_struct,
                                            IPQ_LOG_DEBUG, "whitespace2\n");
                                    return counter;
                                } else if (packet->payload_packet_len >
                                               counter &&
                                           packet->payload[counter] >= 'a' &&
                                           packet->payload[counter] <= 'z') {
                                    counter++;
...
#ifdef IPOQUE_ENABLE_DEBUG_MESSAGES
void ipoque_debug_get_last_log_function_line(
    struct ipoque_detection_module_struct *ipoque_struct, const char **file,
...
#endif
u8 ipoque_detection_get_l4(const u8 *l3, u16 l3_len, const u8 **l4_return,
                           u16 *l4_len_return, u8 *l4_protocol_return,
                           u32 flags) {
    return ipoque_detection_get_l4_internal(
        NULL, l3, l3_len, l4_return, l4_len_return, l4_protocol_return, flags);
}

u8 ipoque_detection_build_key(
    const u8 *l3, u16 l3_len, const u8 *l4, u16 l4_len, u8 l4_protocol,
    struct ipoque_unique_flow_ipv4_and_6_struct *key_return, u8 *dir_return,
    u32 flags) {
    return ipoque_detection_build_key_internal(NULL, l3, l3_len, l4, l4_len,
                                               l4_protocol, key_return,
                                               dir_return, flags);
}

void ipoque_int_add_connection(
    struct ipoque_detection_module_struct *ipoque_struct, u16 detected_protocol,
    ...
    if (src != NULL) {
        IPOQUE_ADD_PROTOCOL_TO_BITMASK(src->detected_protocol_bitmask,
                                       detected_protocol);
    }
    if (dst != NULL) {
        IPOQUE_ADD_PROTOCOL_TO_BITMASK(dst->detected_protocol_bitmask,
                                       detected_protocol);
    }
}

void ipoque_int_change_flow_protocol(
    struct ipoque_detection_module_struct *ipoque_struct, u16 detected_protocol,
    ipoque_protocol_type_t protocol_type) {
    struct ipoque_flow_struct *flow = ipoque_struct->flow;
#if IPOQUE_PROTOCOL_HISTORY_SIZE > 1
     ...
     *   a real protocol in the stack, make sure at least one real protocol
    ...
    if (protocol_type == IPOQUE_CORRELATED_PROTOCOL) {
        ...
        if (stack_size == IPOQUE_PROTOCOL_HISTORY_SIZE) {
            /* check whether we will lost real protocol information due to
             * shifting */
            u16 real_protocol =
                flow->protocol_stack_info.entry_is_real_protocol;

            for (a = 0; a < stack_size; a++) {
                if (real_protocol & 1) break;
                real_protocol >>= 1;
            }

            if (a == (stack_size - 1)) {
                /* oh, only one real protocol at the end, store it and insert it
                 * later */
                saved_real_protocol =
                    flow->detected_protocol_stack[stack_size - 1];
            }
        } else {
        ...
        for (a = stack_size - 1; a > 0; a--) {
            flow->detected_protocol_stack[a] =
                flow->detected_protocol_stack[a - 1];
        }
        ...
        new_is_real = (flow->protocol_stack_info.entry_is_real_protocol &
                       (~preserve_bitmask))
                      << 1;
        new_is_real |=
            flow->protocol_stack_info.entry_is_real_protocol & preserve_bitmask;
...
void ipoque_int_change_packet_protocol(
    struct ipoque_detection_module_struct *ipoque_struct, u16 detected_protocol,
    ipoque_protocol_type_t protocol_type) {
    struct ipoque_packet_struct *packet = &ipoque_struct->packet;
    ...
    if (protocol_type == IPOQUE_CORRELATED_PROTOCOL) {
        ...
        if (stack_size == IPOQUE_PROTOCOL_HISTORY_SIZE) {
             ...
             * shifting */
            u16 real_protocol =
                packet->protocol_stack_info.entry_is_real_protocol;
            ...
            if (a == (stack_size - 1)) {
                 ...
                 * later */
                saved_real_protocol =
                    packet->detected_protocol_stack[stack_size - 1];
            }
        } else {
        ...
        /* now shift and insert */
        for (a = stack_size - 1; a > 0; a--) {
            packet->detected_protocol_stack[a] =
                packet->detected_protocol_stack[a - 1];
        }
        ...
        new_is_real = (packet->protocol_stack_info.entry_is_real_protocol &
                       (~preserve_bitmask))
                      << 1;
        new_is_real |= packet->protocol_stack_info.entry_is_real_protocol &
                       preserve_bitmask;
 ...
 */
u16 ipoque_detection_get_real_protocol_of_flow(
    struct ipoque_detection_module_struct *ipoque_struct) {
    struct ipoque_packet_struct *packet = &ipoque_struct->packet;
#if IPOQUE_PROTOCOL_HISTORY_SIZE > 1
    u8 a;
    ...
    if (!packet) return IPOQUE_PROTOCOL_UNKNOWN;
    ...
    for (a = 0; a < stack_size; a++) {
        if (real_protocol & 1) return packet->detected_protocol_stack[a];
        real_protocol >>= 1;
    }
 ...
 */
u8 ipoque_detection_flow_protocol_history_contains_protocol(
    ...
    for (a = 0; a < stack_size; a++) {
        if (packet->detected_protocol_stack[a] == protocol_id) return 1;
    }
