 ...
 * @author hsu
 */
public class DelCataServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        if (null == account || !PrivilegeUtil.checkAdmin(account.getAccount_limit())) {
            ...
            cata.setId(Integer.parseInt(request.getParameter("cata_id")));
            if (cataDaoConn.deleteCata(cata))
                response.sendRedirect("Admin.jsp");
            else
                response.sendRedirect("Admin.jsp?flag=6");
        }
    }
