 ...
 * @author hsu
 */
public class AddCataServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        if (null == account || !PrivilegeUtil.checkAdmin(account.getAccount_limit())) {
            ...
            cata.setName(request.getParameter("cata_name"));
            if (cataDaoConn.addCata(cata)) {
                response.sendRedirect("Admin.jsp");
            } else {
                response.sendRedirect("Admin.jsp?flag=5");
            }
        }
    }
