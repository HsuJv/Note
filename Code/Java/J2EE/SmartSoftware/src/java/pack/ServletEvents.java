...
public class ServletEvents extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            /* Set the context arribute */
            ctx.setAttribute("URL", "jdbc:odbc:EmployeesDB");
            
            out.println("<B>The JDBC URL has been set as a context attribute at" + new Date() + "<B></br>");
            ctx.removeAttribute("URL");
            out.println("<B>The JDBC URL has been removed from context at" + new Date() + "<B></br>");
